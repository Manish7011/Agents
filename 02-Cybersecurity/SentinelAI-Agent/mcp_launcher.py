...
MCP_SERVICES = [
    {
        ...
        "port": "8001",
        "color": "cyan",
        "cmd": [sys.executable, "-m", "uvicorn", "agents.recon.api:app", "--host", "0.0.0.0", "--port", "8001"],
    },
    {
        "name": "Vulnerability MCP",
        "port": "8002",
        "color": "magenta",
        "cmd": [sys.executable, "-m", "uvicorn", "agents.vulnerability.api:app", "--host", "0.0.0.0", "--port", "8002"],
    },
    {
        "name": "Reporting MCP",
        "port": "8003",
        "color": "yellow",
        "cmd": [sys.executable, "-m", "uvicorn", "agents.reporting.api:app", "--host", "0.0.0.0", "--port", "8003"],
    }
